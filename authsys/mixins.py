...
class ConfirmValidationEmailMixin:
    ...
    def valid_email(self, user, token, datetime):
        ...
        if miliseconds_passed > settings.EMAIL_VALIDATE_MESSAGE_AGE:
            ...
            return render_to_string(self.confirm_failed_template, self.__context)
            ...
            return render_to_string(self.confirm_success_template, self.__context)
